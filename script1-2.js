...
if (typeof GAME === 'undefined') { } else {
    ...
    let Pgg = setInterval(() => {
		...
		$('.MoveIcon[data-option="map_quest_skip_time"]').after('<br><div class="MoveIcon bigg option" data-option="nextchar" data-toggle="tooltip" data-original-title="<div class=tt>Przechodzi na następną postać<br />Klawisz skrótu:<b class=orange>.</b></div>"><span style="color: blue; background-color: black; border: 1px solid white; padding: 8px; cursor: pointer; font-size: 18px;">&rarr;</span></div>');		                
