    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor() {
                ...
                this.addToCSS(`.qtrack strong{font-size: 12px;} .qtrack{width:400px;} #drag_con.scroll .qtrack{width:383px;} #quest_track_con #drag_tracker{user-select:none;} #quest_track_con .sep2{height:14px;} #quest_track_con .sep3{height:14px;}`);
